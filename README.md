...
На данный момент в НА добавляются терморегуляторы для порта "DSen" с типом 
сенсора "1W" при указании "Mode" = "<>" и отмеченной галочкой поля "Action".

<details>
<summary>Пример настройки порта</summary>

![post_request](./data/img/necessary_settings.png)

</details>
<details>
<summary>Вид терморегулятора в НА</summary>

![post_request](./data/img/heater.png)
...
![post_request](./data/img/inverse.png)

</details>
<details>
<summary>Вид терморегулятора в НА</summary>

![post_request](./data/img/cooler.png)
...
- [ ] Добавление терморегуляторов в НА на основе ПИД регуляторов
- [ ] Добавить поддержку I2C блоков расширителей
